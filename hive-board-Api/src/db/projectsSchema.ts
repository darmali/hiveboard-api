...
export const projectsTable = pgTable(
  "projects",
  {
    ...
    project_latitude: doublePrecision(),
    ...
    project_updated_at: timestamp().defaultNow(),
    project_created_by: integer().references(() => usersTable.user_id),
    project_updated_by: integer().references(() => usersTable.user_id),
